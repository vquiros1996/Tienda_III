...
public class PruebasController {
    ...
    //Metodo Buscar
    //Obtener todos los productos y devolverlos en la vista
    @GetMapping("/listado2")
    ...
    //Metodo Buscar,para que cuando se ingrese a la pag listado
    //recibimos el model para buscar los productos y devolverlos
    @PostMapping("/query1")
